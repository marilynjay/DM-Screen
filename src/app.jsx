...
/* Hidden name pools for the 🎲 random-name button. Never listed in the UI — just sampled. `last` is an
   optional surname/clan/epithet; `lastChance` (default 1) is how often it's appended.

   Every entry here is written for this app. Earlier versions leaned on the published race name tables,
   which are not part of the SRD and so aren't covered by the licence the rest of the app relies on —
   an individual name isn't protectable, but reproducing a table largely intact is a different question.
